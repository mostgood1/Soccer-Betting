...
def fetch_h2h_odds(sport_key: str = 'soccer_epl', regions: str = 'uk,eu,us', markets: str = 'h2h', date_format: str = 'iso', odds_format: str = 'decimal', timeout: Optional[int] = None) -> Dict[str, Any]:
                    ...
                    if mk.get('key') == 'h2h':
                        ...
                        for o in outcomes:
                            ...
                            if name and price and price > 1.01 and price < 1000:
                                ...
                                elif lname in ('away', away.lower() if away else 'away'):
                        ...
                        if len(odds_map) >= 2:  # need at least two to compute something
                            ...
                            h2h_payload = {
                                'raw_odds': odds_map,
                                'implied_probabilities': {k: round(v,4) for k,v in probs.items()},
