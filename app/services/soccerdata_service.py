...
class SoccerDataService:
    ...
    def get_epl_teams(self) -> List[Dict]:
        ...
        return [{"id": idx+1, "name": team, "league": "Premier League", "country": "England"} for idx, team in enumerate(epl_teams)]
    ...
    def calculate_team_form(self, team: str, last_n_matches: int = 5) -> Dict[str, any]:
        ...
        form_data["form_points"] = (form_data["wins"] * 3 + form_data["draws"]) / (last_n_matches * 3)
