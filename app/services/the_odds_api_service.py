...
def fetch_the_odds_api(sport_key: str = 'soccer_epl', regions: str = DEFAULT_REGIONS, markets: str = DEFAULT_MARKETS, odds_format: str = DEFAULT_ODDS_FORMAT, date_format: str = 'iso', api_key: str | None = None) -> Dict[str, Any]:
    if requests is None:
            ...
            for bm in bookmakers:
                ...
                for mk in markets_list:
                    ...
                    for o in outcomes:
                        ...
                        canon_outcomes.append({'name': name.upper() if isinstance(name,str) else name, 'price': price})
                ...
                bm_norm.append({'name': bm.get('key') or bm.get('title'), 'markets': norm_markets})
