    ...
    try:
        ...
        if team:
            matches = [
                ...
                if team.lower() in match.get("home_team", "").lower() or 
                   team.lower() in match.get("away_team", "").lower()
            ]
        ...
        return [
            {
                ...
                "total_goals": match.get("total_goals", 
                    (match.get("home_score", 0) + match.get("away_score", 0)) if match.get("home_score") is not None else None
                ),
